...
{
    //Method: Main
    //Purpose: Question 1 on Unit Test, math quiz
    ...
    start:
        ...
        Console.WriteLine("Answer with 2 decimal places if applicable \n");
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Please enter an with 2 decimal places only.");
                    bValid = false;
                }
