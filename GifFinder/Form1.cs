    ...
    public partial class GifFinder : Form
    {
        ...
        private void NewSearchToolStripMenuItem__Click(object sender, EventArgs e)
        {
            ...
            if (searchForm.response == "OK")
            {
                ...
                htmlElement.SetAttribute("vale", searchForm.searchTerm);

                htmlElement = webBrowser1.Document.GetElementById("limit");
                htmlElement.SetAttribute("vale", Convert.ToString(searchForm.maxItems));
        ...
        private void Timer1__Tick(object sender, EventArgs e)
        {
            ...
            if (htmlElement != null)
            {
                ...
                {
                    ImageForm imageForm = new ImageForm(this, htmlElement1.GetAttribute("src"), htmlElement1.GetAttribute("stitlerc"));
                    imageForm.Show();
                }
