...
namespace NumberSort
{
    ...
    class Program
    {
        ...
        //Method: Main
        //Purpose: Questions 2 from Unit Test, ascendng/ descending word in a senetence
        //Output: the ascending or descending words from the sentence
        //Restrictions: None
        ...
        //start:
            ...
            {
                findHiLow = new sortingFunction(FindShortestWord);
            }
            else
            {
                findHiLow = new sortingFunction(FindLongestWord);
            }
            ...
            {
                // store the shortest or longest unsorted value as the next sorted value
                aSorted[nSortedLength] = findHiLow(aUnsorted);  //HERE
        ...
        static string FindShortestWord(string[] array)
        {
            // define return value
            string returnVal;
            ...
            foreach (string thisWord in array)
            {
                ...
                if  (thisWord.CompareTo(returnVal) < 0)  //HERE
                {
