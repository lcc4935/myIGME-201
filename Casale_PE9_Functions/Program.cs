...
namespace Casale_PE9_Functions
{
    //Class: Program
    ...
    class Program
    {
        ...
        //Method: Main
        //Purpose: Questions 2 from the exercise; adding timer to math quiz
        //Output: answers to questions if player gets it wrong
        //Restrictions: None
